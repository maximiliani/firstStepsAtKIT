...
//   *
//   * @param input phonenumber to validate
//   */
//  @Override
...
//  }
  ...
  public boolean isValid(String[] input) throws IllegalArgumentException {
    ...
    if (matcher.find()) {
      ...
      else if (matcher.group(0).equals("110") && input[0].equals("110")) return true;
      else if (matcher.group(0).equals("112") && input[0].equals("112")) return true;
      else if (matcher.group(0).equals("115") && input[0].equals("115")) return true;
      else if (matcher.group(0).equals("0310") && input[0].equals("0310")) return true;
      else if (matcher.group(0).equals("0311") && input[0].equals("0311")) return true;
    }
    throw new IllegalArgumentException();
  }
